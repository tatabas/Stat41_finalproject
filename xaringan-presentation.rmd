...
```{r scatter, echo=FALSE, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 4, dpi = 150}
library(ggplot2)
library(ggthemes)
library(tidyverse)
library(dplyr)
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 4, dpi = 150}
library(patchwork)
