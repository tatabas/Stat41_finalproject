...
```{r scatter, fig.height = 3, fig.width = 4, dpi = 150}
...
```{r happy-map, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r happy-ridges, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 4, dpi = 150}
library(patchwork)
...
```{r crime-plots, fig.width = 10, fig.height= 5}
...
```{r happy-time, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 4, dpi = 150}
...
```{r happy-cor, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 4, dpi = 150}
