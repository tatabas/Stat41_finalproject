...
#2010
robbery10 <- read_excel("robbery_0.xlsx") %>%
...
#2011
robbery11 <- read_excel("robbery_0.xlsx") %>%
...
#2012
robbery12 <- read_excel("robbery_0.xlsx") %>%
...
#2013
robbery13 <- read_excel("robbery_0.xlsx") %>%
...
#2014
robbery14 <- read_excel("robbery_0.xlsx") %>%
...
#2015
robbery15 <- read_excel("robbery_0.xlsx") %>%
...
#2016
robbery16 <- read_excel("robbery_0.xlsx") %>%
...
#2017
robbery17 <- read_excel("robbery_0.xlsx") %>%
...
p1 <- assault %>%
  ...
  ggplot() +
    geom_col(aes(x = Year, y = means, fill = Year)) +
  theme_proj +
...
(Here, we plan on exploring the changes in crime over the years and how they correspond to changes in explicitness of songs over time.)
