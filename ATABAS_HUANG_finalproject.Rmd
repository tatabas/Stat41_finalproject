...
```{r regress-assault, fig.cap="Comparing rate and percent explicit music per year for 2010-2017, displayed by region for each type of crime: assault, robbery, and sexual violence"}
all_together %>%
  ggplot(aes(x = Rate, y = perc_expl, color = year)) +
    ...
    labs(y = "% Explicit Music", color = "Year", caption = "Source: UNODC Crime Data and Spotify API") +
    theme_proj
```
